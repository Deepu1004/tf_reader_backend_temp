 ...
 * in its default assertion - so the seeded {@code readerUsers} demo rows need no second fixture
 * and a sign-in looks the same regardless of which IdP answered it.
 *
